  ...
  experience: [
    {
      ...
      highlights: [
        "Identified that new iGaming platforms were being bootstrapped by copying customized Vue 2 legacy projects, **creating security, compliance, maintainability, and onboarding risks** after Vue 2 reached EOL. Led the architecture and implementation of an **AI-assisted Nuxt Seed Project** with reusable module patterns and **markdown-based Claude Code guardrails**, enabling both developers and AI-generated code to follow consistent state, API, UI, validation, logging, testing, and deployment standards while reducing new project setup effort **from 2+ MD to 1 MD**.",
